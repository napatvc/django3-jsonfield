...
class JSONField(models.Field):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # in an object.
        encoder_class = kwargs.pop('encoder_class', settings.JSONFIELD_ENCODER_CLASS)
        if encoder_class:
            self.encoder_kwargs['cls'] = _resolve_object_path(encoder_class)

        self.decoder_kwargs = dict(kwargs.pop('decoder_kwargs', settings.JSONFIELD_DECODER_KWARGS))
